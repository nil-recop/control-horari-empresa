...
-- Executa aquest fitxer sencer a Supabase: Dashboard -> SQL Editor -> New query -> enganxa i "Run"
...
-- ============================= Row Level Security =============================
-- IMPORTANT: Aquestes polítiques són OBERTES (qualsevol amb la clau "anon" pot
-- llegir/escriure) perquè, de moment, l'aplicació encara no té un sistema
-- d'autenticació real (només PIN intern). És un pas provisional del prototip.
-- Quan implementeu l'autenticació definitiva, s'han de restringir aquestes
-- polítiques perquè cada usuari només pugui veure/editar el que li correspon.
...
-- Esborra aquest bloc si no vols dades d'exemple. Recorda canviar els PIN
-- abans de fer servir l'aplicació amb personal real.
